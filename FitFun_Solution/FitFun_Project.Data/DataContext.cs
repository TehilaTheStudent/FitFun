...
namespace FitFun_Project
{
    ...
    {
        public DbSet<Teacher> teachersData { get; set; }
        public DbSet<Lesson> lessonsData { get; set; }
        public DbSet<Participant> participantsData { get; set; }
      ...
      //  public List<Lesson> lessonsList { get; set; }
       ...
       // public List<Participant> participantsList { get; set; }
        ...
        {
            optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=FitFun_DataBase");
        }
